...
-- windows
vim.keymap.set('n', '<leader>wd', '<cmd>hide<cr>', { desc = '[W]indow delete' })
vim.keymap.set('n', '<leader>wo', '<cmd>resize<cr>', { desc = '[W]indow enlarge' })
vim.keymap.set('n', '<leader>wv', '<cmd>vsplit<cr>', { desc = '[W]indow vertical split' })
vim.keymap.set('n', '<leader>ws', '<cmd>split<cr>', { desc = '[W]indow horizontal split' })
